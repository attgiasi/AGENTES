...
- `confirmations`: frases exigidas para ações perigosas;
...
No painel existe a área `Automação e horários`.

Você pode definir:

- de quantas em quantas horas roda;
- quais horas do dia são permitidas, de 0 a 23;
